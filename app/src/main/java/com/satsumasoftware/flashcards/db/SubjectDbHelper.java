...
public class SubjectDbHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_MDU_COLOR_IDENTIFIER = "mdu_color_identifier";
    ...
    private void populateDatabase(SQLiteDatabase db) {
        ...
        try {
            List<String[]> allRows = parser.parseAll(mContext.getAssets().open(CsvUtils.SUBJECTS));
            for (String[] line : allRows) {
                ...
                values.put(COL_MDU_COLOR_IDENTIFIER, line[3]);
